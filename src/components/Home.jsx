    ...
    <div style={{
      ...
      <div className="container text-center  position-relative">
        ...
        <div className="container mt-3">
          ...
          <p><span className="const">const </span><span className="github">githubLink</span> <span className="text-light"> = </span><a href="https://github.com/yash-png"><span className="github-link ">"https://github.com/yashnerkar"</span></a></p>
        </div>
      </div>
    </div>
  )
